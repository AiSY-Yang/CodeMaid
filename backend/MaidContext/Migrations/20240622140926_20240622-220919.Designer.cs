...
namespace MaidContexts.Migrations
{
    ...
    [Migration("20240622140926_20240622-220919")]
    partial class _20240622220919
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.CodeMaid.ProjectDirectory", b =>
                {
                    ...
                    b.ToTable("ProjectDirectories", t =>
                        {
                            t.HasComment("项目目录");
                        });
                });
            ...
            modelBuilder.Entity("Models.CodeMaid.ProjectDirectoryFile", b =>
                {
                    ...
                    b.Property<int>("FileType")
                        .HasColumnType("integer")
                        .HasComment("文件类型(0-其他,1-C#文件)");

                    b.Property<bool>("IsAutoGen")
                        .HasColumnType("boolean")
                        .HasComment("是否是自动生成的文件");
            ...
            modelBuilder.Entity("Models.CodeMaid.ProjectDirectoryFile", b =>
                {
                    b.HasOne("Models.CodeMaid.ProjectDirectory", "ProjectDirectory")
                        .WithMany("ProjectDirectoryFiles")
                        .HasForeignKey("ProjectDirectoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
